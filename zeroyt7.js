...
//MAU BELI SC ? CHAT AJA : 6285157740529
//MAU NYOLONG CASE / FUNCTION KASIH NAMA GUE :)
...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6283824682542@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe DITZ XD',
			error: {
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE DITZ XD`, 
                            orderTitle: `SUBSCRIBE DITZ XD`,
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe DITZ XD`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe DITZ XD`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
fs.unlinkSync(ran)
})
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
break
case 'tiktok':
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
ini_url = args[0]
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
break
case 'asupanhijaber':
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe DITZ XD'})
break
case 'cecanmalaysia':
...
sendButton(from, "GOPAY : 083824682542 (DitzStore)", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 083824682542 (Muiyah)", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 083824682542 (Muiyah)", faketeks, but, mek)
break
case 'donasi':
...
❏ Runtime = ${runtime(process.uptime())}
❏ Nama Bot = ${botname}
❏ Youtube = https://youtube.com/AditCRAFT
❏ Creator Bot = DITZ XD`
but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
]
...
case 'sc':
hayo = `
Bot Ini Menggunakan Sc Dari Youtube : https://youtube.com/ZeroYT7
Jangan Lupa Di Subscribe Ya

Mau Beli Sc ? Chat : wa.me/6283824682542
Bisa Req Fitur`
...
zeroyt7.sendMessage(`6283824682542@s.whatsapp.net`, options, text, { quoted: ftrol })
